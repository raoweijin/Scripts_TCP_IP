...
def Main():
    ...
    GenFile()
    a.write('AT+UDWNFILE="%s",%s' % (CheckInFilename, len(fileContents)), nonStdResponse='>')
    a.write(fileContents, skipEchoCheck=True, nonStdResponse=fileContents, timeout=3.0)
